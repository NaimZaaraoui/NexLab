...
export const FactureImpression: React.FC<AnalysisPrintProps> = ({ analysis, settings }) => {
  return (
    <div className="bg-[var(--color-surface)] text-[var(--color-text)] font-sans w-[210mm] mx-auto relative print:text-black leading-relaxed">
      ...
      <style jsx global>{`
        ...
        @media print {
          ...
          .footer-content { break-inside: avoid; }
