  ...
  return (
    <div className="grid grid-cols-12 gap-8 mb-8 relative z-10">
      <div className="col-span-5">
        <div className="mb-4">
          <span className="text-xs font-semibold text-[var(--color-accent)] uppercase tracking-[0.1em] print:text-black">Patient</span>
      ...
      <div className="col-span-7 grid grid-cols-2 gap-4">
        <div>
          <span className="text-xs font-semibold text-slate-500 uppercase tracking-[0.1em] print:text-black/60">Date Facture</span>
          <p className="text-sm font-bold text-[var(--color-text)] mt-1 print:text-black">{dateFacture}</p>
        </div>
        <div>
          <span className="text-xs font-semibold text-slate-500 uppercase tracking-[0.1em] print:text-black/60">Prélèvement</span>
          <p className="text-sm font-bold text-[var(--color-text)] mt-1 print:text-black">{dateEdition}</p>
        </div>
        <div className="col-span-2">
          <span className="text-xs font-semibold text-slate-500 uppercase tracking-[0.1em] print:text-black/60">Établissement</span>
