...
function CategoryTableSection({
  ...
  categoryTests: TestWithInventory[];
  allTests: TestWithInventory[];
  labSettings: TestsLabSettings;
  onOpenInventory: (test: TestWithInventory) => void;
  onEdit: (test: TestWithInventory) => void;
          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="bg-[var(--color-surface-muted)] border-b border-[var(--color-border)]">
                <th className="sticky top-0 bg-[var(--color-surface-muted)] z-10 px-5 py-3 text-[11px] font-semibold text-[var(--color-text-secondary)] uppercase tracking-wide w-24">Code</th>
                <th className="sticky top-0 bg-[var(--color-surface-muted)] z-10 px-5 py-3 text-[11px] font-semibold text-[var(--color-text-secondary)] uppercase tracking-wide">Analyse</th>
                <th className="sticky top-0 bg-[var(--color-surface-muted)] z-10 px-5 py-3 text-[11px] font-semibold text-[var(--color-text-secondary)] uppercase tracking-wide text-center">Echantillon</th>
                <th className="sticky top-0 bg-[var(--color-surface-muted)] z-10 px-5 py-3 text-[11px] font-semibold text-[var(--color-text-secondary)] uppercase tracking-wide text-center">Type</th>
                <th className="sticky top-0 bg-[var(--color-surface-muted)] z-10 px-5 py-3 text-[11px] font-semibold text-[var(--color-text-secondary)] uppercase tracking-wide text-center">Reference</th>
                <th className="sticky top-0 bg-[var(--color-surface-muted)] z-10 px-5 py-3 text-[11px] font-semibold text-[var(--color-text-secondary)] uppercase tracking-wide text-center">Montant</th>
                <th className="sticky top-0 bg-[var(--color-surface-muted)] z-10 px-5 py-3 text-[11px] font-semibold text-[var(--color-text-secondary)] uppercase tracking-wide text-center">Conso</th>
                <th className="sticky top-0 bg-[var(--color-surface-muted)] z-10 px-5 py-3 text-[11px] font-semibold text-[var(--color-text-secondary)] uppercase tracking-wide text-right w-24">Actions</th>
              </tr>
            </thead>
