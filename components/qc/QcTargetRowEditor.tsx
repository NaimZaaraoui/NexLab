    ...
    <div className={`grid gap-5 rounded-3xl border p-6 transition-all ${isValid ? 'border-[var(--color-border)] bg-[var(--color-surface)] shadow-sm' : 'border-amber-200 bg-amber-50/30 shadow-none'}`}>
      <div className="flex flex-col gap-4 lg:flex-row lg:items-center">
        <div className="flex-1">
          <label className="block text-xs font-semibold uppercase tracking-[0.06em] text-[var(--color-text-secondary)] mb-2">Paramètre d&apos;analyse</label>
          <select
        ...
        <div className="flex-1 grid grid-cols-2 gap-3">
          <div>
            <label className="block text-xs font-semibold uppercase tracking-[0.06em] text-[var(--color-text-secondary)] mb-2">Code</label>
          ...
          <div>
            <label className="block text-xs font-semibold uppercase tracking-[0.06em] text-[var(--color-text-secondary)] mb-2">Unité</label>
            <div
              contentEditable
      ...
      <div className="grid gap-5 md:grid-cols-3">
        ...
        <div className="md:col-span-2 rounded-2xl bg-[var(--color-surface-muted)] border p-4">
          <h4 className="text-xs font-bold uppercase tracking-[0.08em] text-[var(--color-text-secondary)] mb-4">Configuration des limites</h4>
      ...
      <div className="space-y-3">
        <label className="block text-xs font-semibold uppercase tracking-[0.06em] text-[var(--color-text-secondary)]">Aperçu des zones statistiques (Z-Scores)</label>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-2">
          <div className="flex flex-col rounded-xl border border-blue-100 bg-blue-50/50 p-2.5">
            <span className="text-xs uppercase font-bold text-blue-600">Estimation SD</span>
          ...
          <div className="flex flex-col rounded-xl border border-emerald-100 bg-emerald-50 p-2.5">
            <span className="text-xs uppercase font-bold text-emerald-600">Zone 1 SD (Normal)</span>
          ...
          <div className="flex flex-col rounded-xl border border-amber-100 bg-amber-50 p-2.5">
            <span className="text-xs uppercase font-bold text-amber-600">Zone 2 SD (Alerte)</span>
          ...
          <div className="flex flex-col rounded-xl border border-rose-100 bg-rose-50 p-2.5">
            <span className="text-xs uppercase font-bold text-rose-600">Zone 3 SD (Rejet)</span>
