import { extractFormulaDependencies, validateFormula } from '@/lib/clinical/calculated-tests';
import type { TestCreateInput, TestUpdateInput } from '@/lib/clinical/validators';
...
export function buildTestPersistenceData(
  ...
  return {
    ...
    sampleContainer: payload.sampleContainer ?? null,
